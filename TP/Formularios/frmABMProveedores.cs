...
namespace TP.Formularios
{
    public partial class frmABMProveedores : Form
    {
       ...
       clsProveedores Clientes = new clsProveedores();
        ...
        private void Guardar_Cliente()
        {
            ...
            else
            {
                if (Clientes.Add())
                {
                    MessageBox.Show("Proveedor cargado con exito!");
                }
                else
                {
        ...
        private void cmbPais_SelectionChangeCommitted_1(object sender, EventArgs e)
        {
            asignarPais();
        }
