...
namespace TP.Clases
{
    class clsFacturasCp
    {
        private string _Tabla = "FacturasCp";
        private Int32 _id;
        private Int32 _idProveedor;
        private string _RSProveedor;
        ...
        {
            get { return _RSProveedor; }
            set { _RSProveedor = value; }
        }
        ...
        public bool Add()
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@RSProveedor", RSProveedor);
        ...
        public void GetItemsById(Int32 Valor)
        {
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    RSProveedor = dr["RSProveedor"].ToString();
